                    ...
                    <div className="py-20 md:py-36">
                        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
                            <div>
                                ...
                                <h1 className="mx-auto mt-8 max-w-3xl text-balance text-4xl font-bold tracking-tight sm:text-5xl">{t('title')}</h1>
                                <p className="text-muted-foreground mx-auto my-6 max-w-xl text-balance text-xl">{t('subtitle')}</p>
                                ...
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <Button
                                        ...
                                        variant="outline">
                                        <Link href="#link">
                                            <span className="text-nowrap">{t('watchVideo')}</span>
                                        </Link>
                                    </Button>
                                </div>
                            </div>
