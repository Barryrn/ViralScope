        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <span className="text-xl font-medium">{tCommon('appName')}</span>
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} {tCommon('appName')}, {t('copyright')}</span>
            </div>
        </footer>
    )
}
